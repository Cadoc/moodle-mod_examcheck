...
$string['autoassign'] = 'Auto-assign students';
$string['autoassignconfirm'] = 'Assign the {$a->students} remaining students randomly to the {$a->seats} remaining seats?';
$string['autoassignconfirmbutton'] = 'Assign';
$string['autoassignconfirmtitle'] = 'Auto-assign students';
$string['autoassignresult'] = '{$a->assigned} students assigned to a seat.';
$string['autoassignresultwithleft'] = '{$a->assigned} students assigned to a seat. {$a->left} students still have none.';
$string['autoassignshortbutton'] = 'Assign anyway';
$string['autoassignshortconfirm'] = '{$a->students} students still need a seat but only {$a->seats} are free. If you continue, {$a->seats} students are picked at random and {$a->left} are left without a seat.';
$string['autoassignshorttitle'] = 'Not enough seats';
...
$string['confirmresetseats'] = 'I understand that all existing seat assignments will be reset';
$string['confirmresetseatsrequired'] = 'Confirm that you want to reset all existing seat assignments.';
...
$string['defaultenableseats'] = 'Enable seat numbers by default';
$string['defaultenableseats_desc'] = 'Whether the seat numbers feature is enabled when a new exam check activity is created.';
...
$string['editseats'] = 'Edit seats';
$string['editseatswarning'] = 'Students are currently assigned to seats ({$a} assignments). Saving a changed seat list will remove all of these assignments.';
...
$string['enableseats'] = 'Enable seat numbers';
$string['enableseats_help'] = 'When enabled, teachers who can manage seats get a Seats tab to define a seat list and assign students, the roster and its export gain a Seat column, and the scanner pop-ups show the scanned student\'s seat. When disabled, all of this is hidden and blocked; existing seat data is kept and comes back if the feature is re-enabled.';
$string['error_alreadychecked'] = 'This student has already been checked for this step.';
$string['error_duplicateseat'] = 'The seat "{$a}" is listed more than once. Seat labels must be unique.';
...
$string['error_seatlabeltoolong'] = 'The seat label "{$a}" is too long. Seat labels are limited to 100 characters.';
$string['error_usernotonroster'] = 'This user is not on the roster of this activity.';
$string['eventseatassigned'] = 'Student assigned to a seat';
$string['eventseatunassigned'] = 'Student seat assignment removed';
...
$string['examcheck:manageseats'] = 'Manage the seat list and seat assignments of an exam check activity';
...
$string['importerror_duplicatestudent'] = 'The student "{$a}" is assigned to more than one seat in the file.';
$string['importerror_missingseat'] = 'The seat label is empty.';
$string['importerror_noseatcolumn'] = 'The file has no "seat" column.';
$string['importerror_notonroster'] = 'The user "{$a}" is not on the roster of this activity.';
$string['importerror_seatlabeltoolong'] = 'The seat label "{$a}" is longer than 100 characters.';
...
$string['noseatsyet'] = 'This activity has no seats yet. Use "Edit seats" to create the seat list first.';
...
$string['privacy:metadata:examcheck_seat_users'] = 'Seat assignments: which student sits on which seat, including who recorded each assignment.';
$string['privacy:metadata:examcheck_seat_users:assignedby'] = 'The teacher who recorded the seat assignment.';
$string['privacy:metadata:examcheck_seat_users:seatid'] = 'The seat the student is assigned to.';
$string['privacy:metadata:examcheck_seat_users:timecreated'] = 'The time the seat assignment was recorded.';
$string['privacy:metadata:examcheck_seat_users:userid'] = 'The student assigned to the seat.';
$string['privacy:seats'] = 'Seat assignments';
...
$string['resetseatassignments'] = 'Delete all seat assignments';
...
$string['seat'] = 'Seat';
$string['seatandstudentcount'] = '{$a->seats} of {$a->seatstotal} seats assigned / {$a->students} of {$a->studentstotal} students assigned';
...
Changing the list resets all existing seat assignments.';
$string['seatnoassignment'] = 'No student assigned';
$string['seatresult_assigned'] = '{$a->user} assigned to seat "{$a->seat}".';
$string['seatresult_conflict'] = '{$a->user} is already on seat "{$a->seat}" (assigned by {$a->by}, {$a->ago}).';
$string['seatresult_notassigned'] = 'This seat has no assignment.';
$string['seatresult_unassigned'] = 'Seat assignment removed for {$a}.';
$string['seats'] = 'Seats';
$string['seatsdisabled'] = 'Seat numbers are disabled for this activity.';
$string['seatsearchstudent'] = 'Search for a student';
...
$string['seattoomanyresults'] = 'Too many students match. Keep typing to narrow the search.';
