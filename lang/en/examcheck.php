...
$string['quizactivity_help'] = 'The quiz this step verifies. The student must have submitted at least one attempt to this quiz, and have no attempt left in progress, before they can be marked on this step.';
...
$string['requirequizattempt'] = 'Require a submitted quiz attempt';
$string['requirequizattempt_help'] = 'When enabled, marking a student on this step is only allowed when the student has submitted (finished) at least one attempt to the chosen quiz, with no attempt currently in progress. Useful for an "Exam copy submitted" step backed by a real Moodle quiz.';
$string['resetallchecks'] = 'Clear all checks';
$string['resetmarks'] = 'Delete all recorded checks';
$string['result_attemptmissing_inprogress'] = '{$a->user} still has an attempt in progress on "{$a->quiz}". Ask them to submit before checking.';
$string['result_attemptmissing_misconfigured'] = 'This step requires a submitted quiz attempt, but the quiz is missing or no longer exists. Edit the step to fix it.';
$string['result_attemptmissing_nosubmission'] = '{$a->user} has not submitted any attempt on "{$a->quiz}" yet.';
