...
/**
 * Event fired when a student is assigned to a seat.
 *
 ...
 *      - int seatid: the seat the student was assigned to.
 *      - string seatlabel: the label of the seat.
 * }
 */
class seat_assigned extends base {
    /**
     * Build the event from a freshly created seat assignment.
     *
     * @param context_module $context The module context.
     * @param stdClass $assignment The assignment record (with id set).
    ...
    public static function get_name(): string {
        return get_string('eventseatassigned', 'mod_examcheck');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' assigned the user with id '{$this->relateduserid}' " .
            "to seat '{$this->other['seatlabel']}' (id {$this->other['seatid']}) " .
